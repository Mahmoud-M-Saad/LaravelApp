                    ...
                    <form action="{{ route('posts.destroy',$post['id']) }}" method="POST">
                       <a class="btn btn-primary" style="width: 34px; height:25px; padding:0px;" href="{{route('posts.show', $post['id'])}}">
                        ...
                        @method('DELETE')
                            ...
                            <button type="submit" class="btn btn-danger" style="width: 34px; height:25px; padding:0px;" onclick="return confirm('Are you sure?')"><a class="btn btn-danger" style="width: 34px; height:25px; padding:0px;" href="{{ route('posts.destroy', $post['id']) }}">
