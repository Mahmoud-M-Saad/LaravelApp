...
@section('content')
        ...
        <table
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <a class="btn btn-primary" style="width: 34px; height:25px; padding:0px;" href="{{route('posts.show', $post['id'])}}">
                    ...
                    <a class="btn btn-success" style="width: 34px; height:25px; padding:0px;" href="{{ route('posts.edit', $post['id']) }}">
                        <svg style="width: 100%; height:90%"
                         xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit-circle" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    @csrf
                    @method('DELETE')
                    <a class="btn btn-danger" style="width: 34px; height:25px; padding:0px;" href="{{ route('posts.edit', $post['id']) }}">
                    <button type="submit" style="display:none;" onclick="return confirm('Are you sure?')">
                        
                         </button><svg style="width: 100%; height:90%" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        function ConfirmMessage(){
            result=confirm("Are you sure you want delete this record ?");
            if (result){
