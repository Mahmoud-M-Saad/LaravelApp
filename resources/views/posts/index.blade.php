...
@section('content')
        ...
        <table
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <a  href="{{route('posts.show', $post['id'])}}"><svg
                    ...
                    <a  href="{{ route('posts.edit', $post['id']) }}"><svg
                    ...
                    <button type="submit" onclick=ConfirmMessage();><a  href="{{ route('posts.edit', $post['id']) }}"> <svg
        ...
        function ConfirmMessage(){
            alert("Are you sure you want delete this record ?");
