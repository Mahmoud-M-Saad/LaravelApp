            ...
            <tbody>
                ...
                <tr>
                    ...
                    <button type="submit" style="display:none;" onclick="return confirm('Are you sure?')">
                         ...
                         </button><svg style="width: 100%; height:90%" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
